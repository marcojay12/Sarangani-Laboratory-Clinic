...
export const ContextProvider =({children}) => {
    ...
    const [medtechs, setMedTechs] = useState(tmpMt)
    const [pathologist, setPathologist] = useState(tmpPathologist)
        const [userInfos, setUserInfo] = useState(tmpUserInfo)
